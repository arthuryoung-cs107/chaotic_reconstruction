...
#declare zoom=16*6.0/7.5;

camera {
	orthographic
	location <DISHX,DISHY,180>
...
light_source{<-30,30,110> color rgb <0.97,0.95,0.95>}
light_source{<35,-12,60> color rgb <0.68,0.70,0.70>}
...
union {
#include "ref.pov"
texture{finish{ambient 0.9 diffuse 0.4} pigment{rgb <1,0.1,0.1>}}
}
