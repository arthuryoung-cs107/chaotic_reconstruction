...
struct race_param {
    ...
    race_param(double dt_sim_,double rs_thresh_,double x_pert_,double v_pert_,double omega_pert_,double t_wheels_,double gau_scale_)
    ...
    race_param(fil_param &f) : dt_sim(f.dt_sim), rs_thresh(f.rs_thresh),
