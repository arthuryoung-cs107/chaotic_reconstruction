...
MH_medic::MH_medic(thread_worker_struct &tws_, int thread_id_, double alpha_tol_, int Frames_test_, char * test_buffer_): basic_thread_worker(tws_, thread_id_, alpha_tol_),
