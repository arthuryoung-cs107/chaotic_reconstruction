...
void pedestrian::write_gen_diagnostics(int gen_count_, int leader_count_, int worst_leader_, int best_leader_, double t_wheels_)
{
  int header[] = {7,1}; // {int_len, double_len}
  int int_params[] = {gen_count_, leader_count_, grade_int_len, grade_double_len, len, worst_leader_, best_leader_};
  double double_params [] = {t_wheels_};
  ...
  fwrite(dup_vec, sizeof(int), leader_count_, out_dat);
...
void pedestrian::close_diagnostics(int gen_count_, int worst_leader_, int best_leader_, double t_wheels_)
{
  int header[] = {7,1}; // {int_len, double_len}
