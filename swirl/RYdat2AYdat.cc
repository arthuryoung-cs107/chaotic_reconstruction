...
int set_special_params(int id_, double *vec_)
{
  ...
  switch(id_)
  {
    ...
    case 1: // min parameters
      ...
      {double p_use[]={0.5,1.0,500.0 ,10.0  ,10.0  ,10.0  ,0.1,0.1 ,0.1,1.8,203.0,178.0,27.6,1.0};
    ...
    case 2: // max parameters
      ...
      {double p_use[]={0.5,1.0,2000.0,100.0,100.0,100.0,1.0,1.0 ,1.0,1.8,203.0,178.0,27.6,1.0};
