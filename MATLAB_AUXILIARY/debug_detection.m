...
det = read_detection_group(swtrue, nbeads, par_id, 0,1);
...
if plot_stuff
    ...
    relay_plots.plot_cell_vs_frames(test_fig.ax_tile(4:6), red5, Frame_vec, beadINTres, 'Frames', 'residual integral', 'resint_vs_Frames_bead')
