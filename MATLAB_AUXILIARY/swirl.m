classdef swirl 
  ...
  methods
    ...
    function make_movie(obj, AYfig_in)
      ...
      for i=1:frames
        plot(AYfig_in.ax, wallv(:, 1)+obj.dish(i, 2), wallv(:, 2)+obj.dish(i, 3), 'k -')
        hold(AYfig_in.ax, 'on');
        objdots = scatter(AYfig_in.ax, obj.pos(:, 1, i), obj.pos(:, 2, i), 'o', 'LineWidth', 1, 'SizeData', SS, 'MarkerEdgeColor', [0 0 0], 'MarkerFaceColor', [0.1000 0.4440 0.2440], 'MarkerFaceAlpha', 0.5);
